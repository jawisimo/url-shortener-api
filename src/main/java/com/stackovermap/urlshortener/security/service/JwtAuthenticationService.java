...
import com.stackovermap.urlshortener.security.provider.JwtTokenProvider;
import com.stackovermap.urlshortener.user.UserValidator;
...
import static com.stackovermap.urlshortener.util.MessageProvider.TOKEN_INCORRECT_MESSAGE;
